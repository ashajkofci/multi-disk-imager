...
public static class Localizer
{
    ...
    [
        ...
        "SectorsLabel", "SerialLabel", "ReplaceTitle", "AlreadyExists", "Replace", "ImageTooLarge", "CropAndWrite", "StopWarning"
    ];
